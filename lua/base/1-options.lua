...
-- Theme
vim.g.default_colorscheme = "solarized-flat"
...
vim.opt.scrolloff = 4 -- Number of lines to leave before/after the cursor when scrolling.
vim.opt.sidescrolloff = 4 -- Same but for side scrolling.
